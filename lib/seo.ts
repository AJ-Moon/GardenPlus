...
export const seoFacts = [
  ...
  "Core services include garden design, lawn maintenance, plant supply, drip and sprinkler irrigation, artificial grass, commercial landscaping, corporate grounds care, and large-scale landscape delivery.",
